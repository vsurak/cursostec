...
https://ellow.io/top-backend-technologies/
...
3.2. Diseñando la capa de datos 
3.3. La influencia de BigData, ML e AI
3.4. Tecnologías Enterprise para diseño de arquitecturas de datos como 
Snowflake, Dbt, DataBricks
3.5. Operaciones de base de datos de gran escala
3.6. Diseño de la concurrencia
3.7. Manejo de gran cantidad de conexiones a los datos
