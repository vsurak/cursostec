...
- se encuentra un servicio al que la persona está debidamente subscrita y es el servicio que más utiliza para dicho tipo de tarea, con lo cual recibe la respuesta del servicio según lo solicitado, y de ser neceario nuevas preguntas para el usuario para mejorar los resultados
...
5. una vez que el usuario decide pagar por un servicio o no, se registran en el sistema
...
- pruebe el cluster anterior tanto como distribución, consulta, alta disponibilidad y tolerancia a fallas 
- esto se revisará con cita con el profesor
- utilice docker compose para la configuración del cluster
- todos los scripts, archivos de comandos y datos que sean necesarios para este ejercicio deberán ser mantenidos en un repositorio en github centralizado para todos los integrantes del grupo de trabajo
